            ...
            <div class="grid grid-cols-2 rounded-3xl overflow-hidden w-9/12 shadow-xl">
                ...
                <div class="block bg-surface-50">
                    <div class="w-3/4 mx-auto py-40">
                        ...
                        <!-- signup link -->
                        <p class="text-gray-500 text-sm">Don't have an account yet? Sign up now!</p>

                        <a href="signup" class="btn bg-tertiary-300 text-surface-50 hover:text-secondary-800 hover:bg-primary-50 rounded-xl border-none px-8 py-2 my-1 mt-4 text-sm font-semibold shadow-lg">Sign Up</a>
                    </div>
                </div>
            </div>
        </div>
